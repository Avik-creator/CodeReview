...
export async function postReviewComment(
  ...
  await octokit.rest.issues.createComment({
    ...
    body: `## AI Code Review \n\n${review}\n\n---\n*This review was generated by CodeReviewer AI*`,
  });
}
...
export async function replyToComment(
  ...
  const mention = replyToUser ? `@${replyToUser} ` : "";

  await octokit.rest.issues.createComment({
    owner,
    repo,
    issue_number: prNumber,
    body: `${mention}${reply}\n\n---\n*Response by CodeReviewer AI*`,
  });
}
...
export async function getPRComments(
  ...
  Array<{ id: number; user: string; body: string; createdAt: string }>
> {
  const octokit = new Octokit({ auth: token });
